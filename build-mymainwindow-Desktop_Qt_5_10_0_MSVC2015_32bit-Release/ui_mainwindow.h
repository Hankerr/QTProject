...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/myimages/myimages/CloseFile.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/myimages/myimages/Copying.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Copy->setIcon(icon6);
        action_Cut = new QAction(MainWindow);
        action_Cut->setObjectName(QStringLiteral("action_Cut"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/myimages/myimages/Cutting.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Cut->setIcon(icon7);
        action_Paste = new QAction(MainWindow);
        action_Paste->setObjectName(QStringLiteral("action_Paste"));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/myimages/myimages/Paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Paste->setIcon(icon8);
        action_Find = new QAction(MainWindow);
        action_Find->setObjectName(QStringLiteral("action_Find"));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/myimages/myimages/Finding.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Find->setIcon(icon9);
        action_Version = new QAction(MainWindow);
        action_Version->setObjectName(QStringLiteral("action_Version"));
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/myimages/myimages/Version.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Version->setIcon(icon10);
